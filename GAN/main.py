...
def main(config):
    ...
    # Data loader
    mydata_loader = get_loader(config.image_path, None, config.crop_size,
                                 config.image_size, config.batch_size, config.mode)

    # Solver
    solver = Solver(mydata_loader, config)
...
if __name__ == '__main__':
    ...
    # Path
    parser.add_argument('--image_path', type=str, default='./data/RaFD/train')
